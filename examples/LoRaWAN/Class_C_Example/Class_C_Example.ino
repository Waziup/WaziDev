...
// DevAddr: 26011D15
unsigned char devAddr[4] = {0x26, 0x01, 0x1D, 0x15};
...
void setup() {
  ...
  Serial.println("LoRaWAN Class C Test");
...
void loop() {
  ...
  uint8_t err = wazidev.receiveLoRaWAN(xlpp.buf, &xlpp.offset, &xlpp.len, 5000);
  switch(err) {
  case 0: // OK
